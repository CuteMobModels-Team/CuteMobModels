...
public class ModelCMMRMooshroom extends ModelBase
{
    ModelRenderer HTop;
    ...
    public ModelCMMRMooshroom(final float modelSize, final float offset) {
        ...
        (this.LAntenna = new ModelRenderer((ModelBase)this, 0, 35)).addBox(4.0f, -9.0f, -1.0f, 1, 4, 1);
        this.LAntenna.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.LAntenna.setTextureSize(this.textureWidth, this.textureHeight);
        this.LAntenna.mirror = true;
        this.setRotation(this.LAntenna, 0.0f, 0.0f, 0.0f);
        (this.RAntenna = new ModelRenderer((ModelBase)this, 4, 35)).addBox(-5.0f, -9.0f, -1.0f, 1, 4, 1);
        this.RAntenna.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.RAntenna.setTextureSize(this.textureWidth, this.textureHeight);
        this.RAntenna.mirror = true;
        this.setRotation(this.RAntenna, 0.0f, 0.0f, 0.0f);
        (this.LEar = new ModelRenderer((ModelBase)this, 8, 35)).addBox(4.0f, -5.0f, -2.3f, 1, 3, 3);
        ...
        (this.REar = new ModelRenderer((ModelBase)this, 16, 35)).addBox(-5.0f, -5.0f, -2.3f, 1, 3, 3);
        ...
        (this.Skirt1 = new ModelRenderer((ModelBase)this, 42, 30)).addBox(-3.5f, 0.0f, -2.0f, 7, 4, 4);
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        ...
        this.LAntenna.rotateAngleY = this.Head.rotateAngleY;
        this.LAntenna.rotateAngleX = this.Head.rotateAngleX;
        this.RAntenna.rotateAngleY = this.Head.rotateAngleY;
        this.RAntenna.rotateAngleX = this.Head.rotateAngleX;
        ...
        if (((EntityMooshroom)par7Entity).isChild()) {
    ...
    public void render(final Entity par1Entity, final float par2, final float par3, final float par4, final float par5, final float par6, final float scale) {
        ...
        if (!YarrCuteMobModelsRemake.humanMobsModels) {
            ...
            this.LAntenna.render(scale);
            this.RAntenna.render(scale);
