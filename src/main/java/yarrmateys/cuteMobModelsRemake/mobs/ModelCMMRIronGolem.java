...
public class ModelCMMRIronGolem extends ModelBase
{
    ModelRenderer HTop;
    ModelRenderer HLeft;
    ModelRenderer Hair;
    ...
    public ModelCMMRIronGolem(final float modelSize, final float offset) {
        this.textureWidth = 64;
        this.textureHeight = 64;
        (this.HTop = new ModelRenderer((ModelBase)this, 0, 26)).addBox(-4.0f, -9.0f, -3.5f, 8, 3, 7);
        ...
        (this.HLeft = new ModelRenderer((ModelBase)this, 32, 0)).addBox(3.5f, -8.0f, -0.5f, 1, 4, 1);
        ...
        (this.RArm = new ModelRenderer((ModelBase)this, 36, 0)).addBox(-2.0f, -1.0f, -1.0f, 2, 13, 2);
        ...
        (this.LArm = new ModelRenderer((ModelBase)this, 44, 0)).addBox(0.0f, -1.0f, -1.0f, 2, 13, 2);
        ...
        this.BustTop.setRotationPoint(0.0f, 0.9f, -1.5f);
        ...
        this.BustFront.setRotationPoint(0.0f, -1.0f, 0.0f);
        ...
        this.BustBottom.setRotationPoint(0.0f, 2.5f, -2.0f);
        ...
        (this.Skirt = new ModelRenderer((ModelBase)this, 38, 39)).addBox(-4.0f, 0.0f, -2.5f, 8, 3, 5);
        ...
        (this.Skirt2 = new ModelRenderer((ModelBase)this, 42, 32)).addBox(-3.5f, 0.0f, -2.0f, 7, 3, 4);
        ...
        (this.RLeg = new ModelRenderer((ModelBase)this, 52, 0)).addBox(-1.5f, 0.0f, -1.5f, 3, 13, 3);
        ...
        (this.LLeg = new ModelRenderer((ModelBase)this, 52, 16)).addBox(-1.5f, 0.0f, -1.5f, 3, 13, 3);
        ...
        (this.bypedHead = new ModelRenderer((ModelBase)this, 0, 0)).addBox(-4.0f, -8.0f, -4.0f, 8, 8, 8);
        ...
        (this.bypedBody = new ModelRenderer((ModelBase)this, 16, 16)).addBox(-4.0f, 0.0f, -2.0f, 8, 12, 4);
        ...
        (this.bypedRightArm = new ModelRenderer((ModelBase)this, 40, 16)).addBox(-3.0f, -2.0f, -2.0f, 4, 12, 4);
        ...
        (this.bypedLeftArm = new ModelRenderer((ModelBase)this, 32, 48)).addBox(-1.0f, -2.0f, -2.0f, 4, 12, 4);
        ...
        (this.bypedRightLeg = new ModelRenderer((ModelBase)this, 0, 16)).addBox(-2.0f, 0.0f, -2.0f, 4, 12, 4);
        this.bypedRightLeg.setRotationPoint(-1.9f, 12.0f, 0.0f);
        this.bypedRightLeg.setTextureSize(this.textureWidthbyped, this.textureHeightbyped);
        (this.bypedLeftLeg = new ModelRenderer((ModelBase)this, 16, 48)).addBox(-2.0f, 0.0f, -2.0f, 4, 12, 4);
        this.bypedLeftLeg.setRotationPoint(1.9f, 12.0f, 0.0f);
        this.bypedLeftLeg.setTextureSize(this.textureWidthbyped, this.textureHeightbyped);
        (this.bypedHeadwear = new ModelRenderer((ModelBase)this, 32, 0)).addBox(-4.0f, -8.0f, -4.0f, 8, 8, 8);
        this.bypedHeadwear.setRotationPoint(0.0f, 0.0f, 0.0f);
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        ...
        this.RArm.rotateAngleZ = 0.1f * MathHelper.sin(par3 * 0.05f) + 0.1f;
        this.LArm.rotateAngleZ = -0.1f * MathHelper.sin(par3 * 0.05f) - 0.1f;
        this.RLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662f) * 0.6f * par2;
        this.LLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662f + 3.1415927f) * 0.6f * par2;
        this.RLeg.rotateAngleY = 0.0f;
        this.LLeg.rotateAngleY = 0.0f;
        final EntityIronGolem entityirongolem = (EntityIronGolem)par7Entity;
        if (((EntityIronGolem)par7Entity).isChild()) {
        ...
        if (entityirongolem.getAttackTimer() == 0) {
            if ((par7Entity.onGround && !this.isOnLadder) || par7Entity.isInWater()) {
    ...
    public void setLivingAnimations(final EntityLivingBase par1EntityLivingBase, final float par2, final float par3, final float par4) {
        ...
        if (i > 0) {
            this.RArm.rotateAngleX = -2.0f + 1.5f * this.triangleWave(i - par4, 10.0f);
            this.LArm.rotateAngleX = -2.0f + 1.5f * this.triangleWave(i - par4, 10.0f);
        }
        else {
            final int j = entityirongolem.getHoldRoseTick();
            if (j > 0) {
                this.RArm.rotateAngleX = -0.8f + 0.025f * this.triangleWave((float)j, 70.0f);
                this.LArm.rotateAngleX = 0.0f;
            }
            else {
                this.RArm.rotateAngleX = (-0.2f + 1.5f * this.triangleWave(par2, 13.0f)) * par3;
                this.LArm.rotateAngleX = (-0.2f - 1.5f * this.triangleWave(par2, 13.0f)) * par3;
            }
        }
    }
