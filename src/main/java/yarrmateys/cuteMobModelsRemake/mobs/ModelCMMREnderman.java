...
public class ModelCMMREnderman extends ModelBase
{
    ...
    public ModelCMMREnderman(final float modelSize, final float offset) {
        this.textureWidth = 64;
        this.textureHeight = 64;
        (this.HTop = new ModelRenderer((ModelBase)this, 0, 35)).addBox(-3.5f, -9.0f, -3.0f, 7, 1, 6);
        ...
        (this.Hat = new ModelRenderer((ModelBase)this, 0, 25)).addBox(-4.0f, -8.0f, -3.5f, 8, 3, 7);
        ...
        (this.Hair = new ModelRenderer((ModelBase)this, 0, 11)).addBox(-4.0f, -5.0f, -3.5f, 8, 7, 7);
        ...
        (this.BHair = new ModelRenderer((ModelBase)this, 30, 14)).addBox(-4.0f, 0.0f, 2.5f, 8, 11, 1);
        ...
        (this.Neck1 = new ModelRenderer((ModelBase)this, 0, 42)).addBox(-1.5f, -1.0f, -1.5f, 3, 2, 3);
        ...
        (this.Neck2 = new ModelRenderer((ModelBase)this, 40, 45)).addBox(-3.5f, 0.0f, -2.5f, 7, 1, 5);
        ...
        (this.Skirt1 = new ModelRenderer((ModelBase)this, 42, 30)).addBox(-3.5f, 0.0f, -2.0f, 7, 3, 4);
        ...
        (this.Skirt2 = new ModelRenderer((ModelBase)this, 38, 37)).addBox(-4.0f, 0.0f, -2.5f, 8, 3, 5);
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        ...
        this.BHair.rotateAngleY = this.Head.rotateAngleY / 1.00025f;
        this.BHair.rotateAngleX = 0.1745329f;
        this.BHair.rotateAngleZ = this.Head.rotateAngleZ;
        this.Neck1.rotateAngleY = this.Head.rotateAngleY / 2.0f;
        this.Neck2.rotateAngleY = this.Head.rotateAngleY / 1.25f;
        ...
        if (this.RArm.rotateAngleX > var7) {
            this.RArm.rotateAngleX = var7;
        }
        if (this.LArm.rotateAngleX > var7) {
            this.LArm.rotateAngleX = var7;
        }
        if (this.RArm.rotateAngleX < -var7) {
            this.RArm.rotateAngleX = -var7;
        }
        ...
        if (this.RLeg.rotateAngleX > var7) {
            this.RLeg.rotateAngleX = var7;
        }
        if (this.LLeg.rotateAngleX > var7) {
            this.LLeg.rotateAngleX = var7;
        }
        if (this.RLeg.rotateAngleX < -var7) {
            this.RLeg.rotateAngleX = -var7;
        }
        ...
        if (this.isCarrying) {
            this.RArm.rotateAngleX = -0.7f;
            this.LArm.rotateAngleX = -0.7f;
        }
        else if ((par7Entity.onGround && !this.isOnLadder) || par7Entity.isInWater() || this.isRiding) {
        ...
        if (this.isCarrying) {
            this.bypedRightArm.rotateAngleX = -0.7f;
            this.bypedLeftArm.rotateAngleX = -0.7f;
        }
        if (this.isRiding) {
