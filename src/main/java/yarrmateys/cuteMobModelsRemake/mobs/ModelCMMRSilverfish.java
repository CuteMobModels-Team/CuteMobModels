...
public class ModelCMMRSilverfish extends ModelBase
{
    ...
    public ModelCMMRSilverfish(final float modelSize, final float offset) {
        ...
        (this.Hat = new ModelRenderer((ModelBase)this, 0, 52)).addBox(3.0f, -8.5f, -2.0f, 3, 5, 4);
        ...
        (this.Neck = new ModelRenderer((ModelBase)this, 20, 35)).addBox(-1.5f, -1.0f, -1.5f, 3, 2, 3);
        this.Neck.setRotationPoint(0.0f, 2.0f, 0.0f);
        this.Neck.setTextureSize(this.textureWidth, this.textureHeight);
        this.Neck.mirror = true;
        this.setRotation(this.Neck, 0.0f, 0.0f, 0.0f);
        (this.RArm = new ModelRenderer((ModelBase)this, 36, 0)).addBox(-2.0f, -1.0f, -1.0f, 2, 9, 2);
        ...
        (this.LArm = new ModelRenderer((ModelBase)this, 44, 0)).addBox(0.0f, -1.0f, -1.0f, 2, 9, 2);
        ...
        (this.Skirt = new ModelRenderer((ModelBase)this, 34, 43)).addBox(-4.5f, 0.0f, -3.0f, 9, 3, 6);
        this.Skirt.setRotationPoint(0.0f, 14.0f, 0.0f);
        ...
        (this.Skirt3 = new ModelRenderer((ModelBase)this, 26, 52)).addBox(-5.5f, 3.0f, -4.0f, 11, 4, 8);
        this.Skirt3.setRotationPoint(0.0f, 14.0f, 0.0f);
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        ...
        this.Skirt.offsetZ = 0.0f;
        this.Skirt3.offsetY = this.Skirt.offsetY;
        this.Skirt3.offsetZ = this.Skirt.offsetZ;
        ...
        if (this.isRiding) {
            ...
            this.Skirt2.rotateAngleX = 0.0f;
            this.Skirt2.rotateAngleY = 0.0f;
            this.Skirt.rotateAngleX = this.RLeg.rotateAngleX;
            this.Skirt.rotateAngleY = 0.0f;
            this.Skirt3.rotateAngleX = this.RLeg.rotateAngleX;
            this.Skirt3.rotateAngleY = 0.0f;
            this.RLeg.offsetY = -0.1f;
            this.LLeg.offsetY = -0.1f;
            this.Skirt.offsetY = -0.03f;
            this.Skirt3.offsetY = this.Skirt.offsetY;
            this.Skirt.offsetZ = 0.0f;
            this.Skirt3.offsetZ = this.Skirt.offsetZ;
        }
