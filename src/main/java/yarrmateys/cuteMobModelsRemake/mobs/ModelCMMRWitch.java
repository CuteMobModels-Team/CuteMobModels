...
public class ModelCMMRWitch extends ModelBase
{
    ModelRenderer Hat4;
    ModelRenderer Hat3;
    ModelRenderer Hat2;
    ...
    private ModelRenderer bypedHat;
    private ModelRenderer bypedHat1;
    private ModelRenderer bypedHat2;
    private ModelRenderer bypedHat3;
    private ModelRenderer bypedHat4;
    ...
    public ModelCMMRWitch(final float modelSize, final float offset) {
        this.textureWidth = 128;
        this.textureHeight = 64;
        (this.Hat4 = new ModelRenderer((ModelBase)this, 64, 36)).addBox(-2.0f, -15.46667f, -4.0f, 4, 3, 7);
        this.Hat4.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Hat4.setTextureSize(this.textureWidth, this.textureHeight);
        this.Hat4.mirror = true;
        this.setRotation(this.Hat4, -0.3346075f, 0.0f, 0.0f);
        (this.Hat3 = new ModelRenderer((ModelBase)this, 64, 25)).addBox(-3.0f, -13.0f, -9.0f, 6, 5, 6);
        this.Hat3.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Hat3.setTextureSize(this.textureWidth, this.textureHeight);
        this.Hat3.mirror = true;
        this.setRotation(this.Hat3, -0.6283185f, 0.0f, 0.0f);
        (this.Hat2 = new ModelRenderer((ModelBase)this, 64, 13)).addBox(-4.0f, -12.0f, -3.5f, 8, 5, 7);
        ...
        (this.Hat1 = new ModelRenderer((ModelBase)this, 64, 0)).addBox(-7.0f, -7.0f, -6.0f, 14, 1, 12);
        ...
        (this.Hair = new ModelRenderer((ModelBase)this, 0, 12)).addBox(-4.0f, -6.0f, -3.5f, 8, 10, 7);
        ...
        (this.Neck = new ModelRenderer((ModelBase)this, 96, 57)).addBox(-1.5f, -1.0f, -1.5f, 3, 2, 3);
        this.Neck.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Neck.setTextureSize(this.textureWidth, this.textureHeight);
        this.Neck.mirror = true;
        this.setRotation(this.Neck, 0.0f, 0.0f, 0.0f);
        (this.HBack = new ModelRenderer((ModelBase)this, 0, 32)).addBox(-4.0f, 1.0f, 2.3f, 8, 12, 1);
        this.HBack.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.HBack.setTextureSize(this.textureWidth, this.textureHeight);
        this.HBack.mirror = true;
        this.setRotation(this.HBack, 0.1745329f, 0.0f, 0.0f);
        (this.RArm = new ModelRenderer((ModelBase)this, 36, 0)).addBox(-2.0f, -1.0f, -1.0f, 2, 4, 2);
        ...
        (this.RArm2 = new ModelRenderer((ModelBase)this, 40, 8)).addBox(-2.5f, 3.0f, -1.5f, 3, 8, 3);
        ...
        (this.LArm = new ModelRenderer((ModelBase)this, 44, 0)).addBox(0.0f, -1.0f, -1.0f, 2, 4, 2);
        ...
        (this.LArm2 = new ModelRenderer((ModelBase)this, 40, 19)).addBox(-0.5f, 3.0f, -1.5f, 3, 8, 3);
        ...
        (this.Body = new ModelRenderer((ModelBase)this, 108, 46)).addBox(-3.5f, 1.0f, -1.5f, 7, 5, 3);
        this.Body.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Body.setTextureSize(this.textureWidth, this.textureHeight);
        this.Body.mirror = true;
        this.setRotation(this.Body, 0.0f, 0.0f, 0.0f);
        (this.BustTop = new ModelRenderer((ModelBase)this, 92, 45)).addBox(-3.0f, 0.0f, 0.0f, 6, 2, 2);
        this.BustTop.setRotationPoint(0.0f, 2.9f, -1.5f);
        ...
        (this.BustFront = new ModelRenderer((ModelBase)this, 92, 49)).addBox(-3.0f, 0.0f, -2.9f, 6, 2, 2);
        this.BustFront.setRotationPoint(0.0f, 4.3f, 0.0f);
        ...
        (this.BustBottom = new ModelRenderer((ModelBase)this, 92, 53)).addBox(-3.0f, 0.0f, 0.0f, 6, 2, 2);
        this.BustBottom.setRotationPoint(0.0f, 4.5f, -2.0f);
        ...
        (this.Body2 = new ModelRenderer((ModelBase)this, 110, 54)).addBox(-3.0f, 6.0f, -1.5f, 6, 6, 3);
        this.Body2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.Body2.setTextureSize(this.textureWidth, this.textureHeight);
        this.Body2.mirror = true;
        this.setRotation(this.Body2, 0.0f, 0.0f, 0.0f);
        (this.Skirt2 = new ModelRenderer((ModelBase)this, 106, 13)).addBox(-3.5f, 0.0f, -2.0f, 7, 4, 4);
        ...
        (this.Skirt = new ModelRenderer((ModelBase)this, 100, 21)).addBox(-4.0f, 4.0f, -3.0f, 8, 5, 6);
        ...
        (this.Skirt3 = new ModelRenderer((ModelBase)this, 94, 32)).addBox(-4.5f, 9.0f, -4.0f, 9, 5, 8);
        ...
        (this.bypedHat4 = new ModelRenderer((ModelBase)this, 64, 36)).addBox(-2.0f, -16.46667f, -4.0f, 4, 3, 7);
        this.bypedHat4.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.bypedHat4.setTextureSize(this.textureWidthbyped, this.textureHeightbyped);
        this.bypedHat4.mirror = true;
        this.setRotation(this.bypedHat4, -0.3346075f, 0.0f, 0.0f);
        (this.bypedHat3 = new ModelRenderer((ModelBase)this, 64, 25)).addBox(-3.0f, -14.0f, -9.0f, 6, 5, 6);
        this.bypedHat3.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.bypedHat3.setTextureSize(this.textureWidthbyped, this.textureHeightbyped);
        this.bypedHat3.mirror = true;
        this.setRotation(this.bypedHat3, -0.6283185f, 0.0f, 0.0f);
        (this.bypedHat2 = new ModelRenderer((ModelBase)this, 64, 12)).addBox(-4.5f, -13.0f, -4.0f, 9, 5, 8);
        this.bypedHat2.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.bypedHat2.setTextureSize(this.textureWidthbyped, this.textureHeightbyped);
        this.bypedHat2.mirror = true;
        this.setRotation(this.bypedHat2, 0.0f, 0.0f, 0.0f);
        (this.bypedHat1 = new ModelRenderer((ModelBase)this, 64, 0)).addBox(-7.0f, -8.0f, -6.0f, 14, 1, 12);
        this.bypedHat1.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.bypedHat1.setTextureSize(this.textureWidthbyped, this.textureHeightbyped);
        this.bypedHat1.mirror = true;
        this.setRotation(this.bypedHat1, 0.0f, 0.0f, 0.0f);
    }
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        ...
        this.HBack.rotateAngleY = this.Head.rotateAngleY / 2.0f;
        this.HBack.rotateAngleX = 0.1745329f + this.Head.rotateAngleX;
        ...
        this.Hat3.rotateAngleY = this.Head.rotateAngleY;
        this.Hat3.rotateAngleX = -0.6283185f + this.Head.rotateAngleX;
        this.Hat4.rotateAngleY = this.Head.rotateAngleY;
        this.Hat4.rotateAngleX = -0.3346075f + this.Head.rotateAngleX;
        this.RArm.rotateAngleX = MathHelper.cos(par1 * 0.6662f + 3.1415927f) * 0.6f * par2;
        ...
        this.LArm.rotateAngleX = MathHelper.cos(par1 * 0.6662f) * 0.6f * par2;
        ...
        this.RLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662f) * 0.4f * par2;
        this.LLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662f + 3.1415927f) * 0.4f * par2;
        ...
        if (((EntityWitch)par7Entity).isChild()) {
        ...
        this.bypedHat1.rotateAngleY = this.bypedHead.rotateAngleY;
        this.bypedHat1.rotateAngleX = this.bypedHead.rotateAngleX;
        this.bypedHat2.rotateAngleY = this.bypedHead.rotateAngleY;
        this.bypedHat2.rotateAngleX = this.bypedHead.rotateAngleX;
        this.bypedHat3.rotateAngleY = this.bypedHead.rotateAngleY;
        this.bypedHat3.rotateAngleX = -0.6283185f + this.bypedHead.rotateAngleX;
        this.bypedHat4.rotateAngleY = this.bypedHead.rotateAngleY;
        this.bypedHat4.rotateAngleX = -0.3346075f + this.bypedHead.rotateAngleX;
    }
    ...
    public void render(final Entity par1Entity, final float par2, final float par3, final float par4, final float par5, final float par6, final float scale) {
        ...
        if (!YarrCuteMobModelsRemake.humanMobsModels) {
            ...
            this.bypedHat1.render(scale);
            this.bypedHat2.render(scale);
            this.bypedHat3.render(scale);
            this.bypedHat4.render(scale);
        }
        else {
