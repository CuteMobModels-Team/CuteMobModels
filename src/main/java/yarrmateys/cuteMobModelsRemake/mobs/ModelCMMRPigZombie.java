...
public class ModelCMMRPigZombie extends ModelBase
{
    ModelRenderer HTop;
    ModelRenderer Hair;
    ModelRenderer Head;
    ...
    public ModelCMMRPigZombie(final float modelSize, final float offset) {
        ...
        (this.Skirt = new ModelRenderer((ModelBase)this, 42, 30)).addBox(-3.5f, 0.0f, -2.0f, 7, 3, 4);
        ...
        (this.LLeg2 = new ModelRenderer((ModelBase)this, 0, 35)).addBox(-1.0f, 0.0f, -2.0f, 3, 6, 4);
        this.LLeg2.setRotationPoint(2.0f, 12.0f, 0.0f);
        this.LLeg2.setTextureSize(this.textureWidth, this.textureHeight);
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        ...
        if (!YarrCuteMobModelsRemake.humanMobsModels) {
            ...
            this.LLeg2.rotateAngleX = this.LLeg.rotateAngleX;
            this.RLeg.rotateAngleY = 0.0f;
            this.LLeg.rotateAngleY = 0.0f;
            this.LLeg2.rotateAngleY = this.LLeg.rotateAngleY;
            if (((EntityPigZombie)par7Entity).isChild()) {
            ...
            if (YarrCuteMobModelsRemake.PigZombieExtendedHands) {
            ...
            if ((par7Entity.onGround && !this.isOnLadder) || YarrCuteMobModelsRemake.PigZombieExtendedHands || par7Entity.isInWater() || this.isRiding) {
            ...
            if (this.isRiding) {
                ...
                rArm4.rotateAngleX -= 0.62831855f;
                final ModelRenderer lArm4 = this.LArm;
                lArm4.rotateAngleX -= 0.62831855f;
            ...
            if (this.isSneak) {
                ...
                bypedRightArm2.rotateAngleX += 0.4f;
                final ModelRenderer bypedLeftArm2 = this.bypedLeftArm;
                bypedLeftArm2.rotateAngleX += 0.4f;
            ...
            bypedRightArm3.rotateAngleZ += MathHelper.cos(par3 * 0.09f) * 0.05f + 0.05f;
            final ModelRenderer bypedLeftArm3 = this.bypedLeftArm;
            bypedLeftArm3.rotateAngleZ -= MathHelper.cos(par3 * 0.09f) * 0.05f + 0.05f;
            final ModelRenderer bypedRightArm4 = this.bypedRightArm;
            bypedRightArm4.rotateAngleX += MathHelper.sin(par3 * 0.067f) * 0.05f;
            final ModelRenderer bypedLeftArm4 = this.bypedLeftArm;
            bypedLeftArm4.rotateAngleX -= MathHelper.sin(par3 * 0.067f) * 0.05f;
            if (this.aimedBow) {
                final float f3 = 0.0f;
                final float f4 = 0.0f;
                this.bypedRightArm.rotateAngleZ = 0.0f;
                this.bypedLeftArm.rotateAngleZ = 0.0f;
                this.bypedRightArm.rotateAngleY = -(0.1f - f3 * 0.6f) + this.bypedHead.rotateAngleY;
                this.bypedLeftArm.rotateAngleY = 0.1f - f3 * 0.6f + this.bypedHead.rotateAngleY + 0.4f;
                ...
                bypedRightArm5.rotateAngleX -= f3 * 1.2f - f4 * 0.4f;
                final ModelRenderer bypedLeftArm5 = this.bypedLeftArm;
                bypedLeftArm5.rotateAngleX -= f3 * 1.2f - f4 * 0.4f;
                ...
                bypedLeftArm6.rotateAngleZ -= MathHelper.cos(par3 * 0.09f) * 0.05f + 0.05f;
                ...
                bypedLeftArm7.rotateAngleX -= MathHelper.sin(par3 * 0.067f) * 0.05f;
            }
            if (YarrCuteMobModelsRemake.PigZombieExtendedHands) {
                this.bypedRightArm.rotateAngleZ = 0.0f;
                this.bypedLeftArm.rotateAngleZ = 0.0f;
                ...
                bypedRightArm8.rotateAngleX -= par7 * 1.2f - par8 * 0.4f;
                final ModelRenderer bypedLeftArm8 = this.bypedLeftArm;
                bypedLeftArm8.rotateAngleX -= par7 * 1.2f - par8 * 0.4f;
                ...
                bypedLeftArm9.rotateAngleZ -= MathHelper.cos(par3 * 0.09f) * 0.05f + 0.05f;
                ...
                bypedLeftArm10.rotateAngleX -= MathHelper.sin(par3 * 0.067f) * 0.05f;
            }
