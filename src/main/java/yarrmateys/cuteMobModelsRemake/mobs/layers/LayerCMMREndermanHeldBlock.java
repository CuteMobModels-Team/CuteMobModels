...
public class LayerCMMREndermanHeldBlock implements LayerRenderer<EntityEnderman>
{
    private final RenderCMMREnderman endermanRenderer;
    
    public LayerCMMREndermanHeldBlock(final RenderCMMREnderman renderCMMREnderman) {
