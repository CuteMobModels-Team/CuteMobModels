...
public class LayerCMMRSkeletonHeldItem implements LayerRenderer
{
    private final RenderLivingBase livingEntityRenderer;
    
    public LayerCMMRSkeletonHeldItem(final RenderLivingBase livingEntityRenderer) {
    ...
    private void renderHeldItem(final EntityLivingBase p_188358_1_, final ItemStack p_188358_2_, final ItemCameraTransforms.TransformType p_188358_3_, final EnumHandSide handSide) {
        if (p_188358_2_ != null) {
            GlStateManager.pushMatrix();
            ((ModelCMMRSkeleton)this.livingEntityRenderer.getMainModel()).postRenderArm(0.0625f, handSide);
