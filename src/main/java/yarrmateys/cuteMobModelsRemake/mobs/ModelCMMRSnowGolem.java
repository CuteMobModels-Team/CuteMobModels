...
public class ModelCMMRSnowGolem extends ModelBase
{
    ModelRenderer Hat;
    ModelRenderer Hair;
    ModelRenderer Head;
    ...
    public ModelCMMRSnowGolem(final float modelSize, final float offset) {
        this.textureWidth = 64;
        this.textureHeight = 64;
        (this.Hat = new ModelRenderer((ModelBase)this, 0, 28)).addBox(-4.0f, -11.0f, -3.5f, 8, 5, 7);
        ...
        (this.Hair = new ModelRenderer((ModelBase)this, 0, 12)).addBox(-4.0f, -6.0f, -3.5f, 8, 9, 7);
        ...
        (this.HNeck = new ModelRenderer((ModelBase)this, 0, 40)).addBox(-3.5f, 0.0f, -2.5f, 7, 1, 5);
        this.HNeck.setRotationPoint(0.0f, 0.0f, 0.0f);
        this.HNeck.setTextureSize(this.textureWidth, this.textureHeight);
        this.HNeck.mirror = true;
        this.setRotation(this.HNeck, 0.0f, 0.0f, 0.0f);
        ...
        (this.RArm2 = new ModelRenderer((ModelBase)this, 30, 14)).addBox(-2.5f, 3.0f, -1.5f, 3, 7, 3);
        ...
        (this.LArm2 = new ModelRenderer((ModelBase)this, 30, 24)).addBox(-0.5f, 3.0f, -1.5f, 3, 7, 3);
        ...
        (this.Skirt = new ModelRenderer((ModelBase)this, 42, 37)).addBox(-3.5f, 0.0f, -2.0f, 7, 3, 4);
        ...
        (this.Skirt2 = new ModelRenderer((ModelBase)this, 38, 44)).addBox(-4.0f, 0.0f, -2.5f, 8, 4, 5);
        ...
        (this.Skirt3 = new ModelRenderer((ModelBase)this, 34, 53)).addBox(-4.5f, 0.0f, -3.0f, 9, 5, 6);
        this.Skirt3.setRotationPoint(0.0f, 16.0f, 0.0f);
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        ...
        this.HNeck.rotateAngleY = this.Head.rotateAngleY / 1.5f;
        ...
        this.RLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662f) * 0.3f * par2;
        this.LLeg.rotateAngleX = MathHelper.cos(par1 * 0.6662f + 3.1415927f) * 0.3f * par2;
