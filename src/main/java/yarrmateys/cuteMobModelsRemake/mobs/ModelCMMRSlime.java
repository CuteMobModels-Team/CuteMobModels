...
public class ModelCMMRSlime extends ModelBase
{
    ModelRenderer Hat;
    ModelRenderer HTop;
    ...
    public ModelCMMRSlime(final float modelSize, final float offset) {
        ...
        (this.Skirt = new ModelRenderer((ModelBase)this, 38, 37)).addBox(-4.0f, 0.0f, -2.5f, 8, 3, 5);
