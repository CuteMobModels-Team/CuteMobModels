...
public class ModelCMMRZombie extends ModelBase
{
    ModelRenderer HTop;
    ModelRenderer HSide;
    ModelRenderer Hair;
    ...
    public ModelCMMRZombie(final float modelSize, final float offset) {
    ...
    public void setRotationAngles(final float par1, final float par2, final float par3, final float par4, final float par5, final float par6, final Entity par7Entity) {
        ...
        this.HSide.isHidden = false;
        this.RArm2.isHidden = true;
        this.LArm2.isHidden = true;
        this.BustTop.isHidden = true;
        this.BustFront.isHidden = true;
        this.BustBottom.isHidden = true;
        this.Body2.isHidden = false;
        this.Body2Z.isHidden = false;
        this.Skirt2.isHidden = true;
        this.Skirt.isHidden = true;
        this.Skirt3.isHidden = true;
